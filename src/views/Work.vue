      ...
      <section class="hello">
          <div class="title-overlay">
            <div class="hello-text">
                ...
                <a href="#" class="latest-work">Latest works</a>
            </div>
          </div>
      </section>
        ...
        <section class="happy-clients">
            ...
            <div class="gallery-items">
                <div class="gallery-text">
                    <h2> Tech </h2>
                    <h2 style="margin-bottom: 20px">Consultancy</h2>

                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
                        Ac dictum nibh nam odio cursus id. Diam massa semper a tincidunt cursus ultricies lectus eget urna.
                    </p>

                    <h3 style="margin-top: 20px">Company X, Region X </h3>
...
/* Hello section with background */
.hello {
    height: 60vh;
    background:linear-gradient(0deg, rgba(255, 0, 150, 0), rgba(47, 128, 237, 0.9)), url(../assets/background.jpeg);
    position: relative;
}
.title-overlay {
    z-index: 2;
